...
from eidolon.livekit.common.conversation_signals import (
    BACKCHANNEL_COMPOUND_CHARS as _BACKCHANNEL_COMPOUND_CHARS,
    BACKCHANNEL_WORDS as _BACKCHANNEL_WORDS,
    NOISE_LIKE_TRANSCRIPTIONS as _NOISE_LIKE_TRANSCRIPTIONS,
...
# -----------------------------------------------------------------------------
BACKCHANNEL_WORDS = _BACKCHANNEL_WORDS
BACKCHANNEL_COMPOUND_CHARS = _BACKCHANNEL_COMPOUND_CHARS
NOISE_LIKE_TRANSCRIPTIONS = _NOISE_LIKE_TRANSCRIPTIONS
