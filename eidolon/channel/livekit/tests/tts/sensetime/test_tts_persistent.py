...
Run with::
    ...
    cd <repository-root>
    .venv/bin/python -m pytest eidolon/channel/livekit/tests/tts/sensetime/test_tts_persistent.py -v -s
"""
...
class TestTTSConnectionLifecycle:
    ...
    async def test_backward_compatibility_alias(self, srv):
        from eidolon.channel.livekit.plugins.tts.sensetime.tts_client import SenseTimeTTSClient
