...
- `full_duplex/` contains the full-duplex realtime AgentSession pipeline:
  ...
  user-state/transcript entry routing, transcript admission/echo gating before
  turn evidence, accepted transcript evidence recording, semantic interrupt
  trigger gating, and explicit client preempt handling for deliberate
