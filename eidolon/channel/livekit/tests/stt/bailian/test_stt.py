...
Run with::
    ...
    python -m pytest eidolon/channel/livekit/plugins/bailian/test_stt.py -v
...
from eidolon.channel.livekit.plugins.stt.bailian import (
    BailianConnectionManager,
    BailianFunASRSTT,
)
from eidolon.channel.livekit.plugins.stt.bailian.connection_manager import (
