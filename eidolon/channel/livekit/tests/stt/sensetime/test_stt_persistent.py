...
Run with::
    ...
    .venv/bin/python -m pytest \
        eidolon/channel/livekit/tests/stt/sensetime/test_stt_persistent.py -v -s
"""
...
from eidolon.channel.livekit.plugins.stt.sensetime.connection import STTConnection
