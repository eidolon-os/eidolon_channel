...
Run with::
    ...
    python -m pytest eidolon/channel/livekit/plugins/vad/firered/test_vad.py -v
...
# eidolon/channel/livekit/plugins/vad/firered/test_vad.py → parents[4] = eidolon/
...
class TestPvadProcessor:
    ...
    def test_processor_load(self):
        ...
        from eidolon.channel.livekit.plugins.vad.firered import PvadProcessor
    ...
    def test_speaker_embedding_graceful_degrade(self):
        ...
        from eidolon.channel.livekit.plugins.vad.firered.processor import SpeakerEmbExtractor
...
class TestVadStageWrapper:
    ...
    async def test_vadstage_holds_vad_instance(self):
        ...
        from eidolon.channel.livekit.agent.pipeline.vad import VadStage
        from eidolon.channel.livekit.plugins.vad.firered import FireredPvadVAD
