...
class TestEidolonEOTConfig:
    ...
    def test_default_values(self):
        from eidolon.channel.livekit.plugins.eot import EidolonEOTConfig
...
class TestConstants:
    ...
    def test_filler_words(self):
        from eidolon.channel.livekit.plugins.eot.impl.constants import FILLER_WORDS
    ...
    def test_command_words(self):
        from eidolon.channel.livekit.plugins.eot.impl.constants import COMMAND_WORDS

        assert "停" in COMMAND_WORDS
        assert "闭嘴" in COMMAND_WORDS

    def test_strong_interrupt_words(self):
        from eidolon.channel.livekit.plugins.eot.impl.constants import (
...
class TestTurnEndPolicy:
    ...
    def test_strong_interrupt_intent(self):
        from eidolon.channel.livekit.plugins.eot import (
            TurnEndPolicy,
        )
    ...
    def test_is_question_ending_simple_particles(self):
        from eidolon.channel.livekit.plugins.eot import TurnEndPolicy
...
class TestUtils:
    ...
    def test_compute_text_hash(self):
        from eidolon.channel.livekit.plugins.eot import compute_text_hash
    ...
    def test_is_similar_text(self):
        from eidolon.channel.livekit.plugins.eot import is_similar_text
...
class TestPolicyChain:
    ...
    def test_for_normal_turn_end_chain(self):
        from eidolon.channel.livekit.plugins.eot import PolicyChain
    ...
    def test_min_interval_policy_blocks_when_not_met(self):
        from eidolon.channel.livekit.plugins.eot import MinIntervalPolicy
        from eidolon.channel.livekit.plugins.eot import TurnDetectionStateManager
        from eidolon.channel.livekit.plugins.eot import TurnEndPolicy
...
class TestG0aDualPathArchitecture:
    ...
    def test_max_history_respects_config(self):
        ...
        from eidolon.channel.livekit.plugins.eot.impl.context_enhanced_eot import ContextEnhancedEot
...
class TestOnnxEotBackend:
    ...
    def test_model_dir_resolution(self):
        from eidolon.channel.livekit.plugins.eot.impl.eot_manager import (
    ...
    def test_backend_loads(self):
        from eidolon.channel.livekit.plugins.eot.impl.eot_backend import OnnxEotBackend

        # Model: eidolon/channel/livekit/plugins/eot/data/model/firered_chat_turn_detector/
        # Test:   eidolon/channel/livekit/tests/eot/test_eot_plugin.py
        # parent.parent.parent = eidolon/channel/livekit/
        default_dir = (
...
class TestPluginRegistration:
    ...
    def test_plugin_import(self):
        from eidolon.channel.livekit.plugins.eot import EidolonEOTPlugin
...
class TestNewPolicies:
    ...
    def test_vad_stability_rapid_toggles_blocked(self):
        from eidolon.channel.livekit.plugins.eot import VADStabilityPolicy
        from eidolon.channel.livekit.plugins.eot import TurnDetectionStateManager
        from eidolon.channel.livekit.plugins.eot import TurnEndPolicy
    ...
    def test_asr_stability_short_text_fast_stabilizes(self):
        from eidolon.channel.livekit.plugins.eot import ASRStabilityPolicy
        from eidolon.channel.livekit.plugins.eot import TurnDetectionStateManager
        from eidolon.channel.livekit.plugins.eot import TurnEndPolicy
    ...
    def test_duplicate_similar_blocked(self):
        from eidolon.channel.livekit.plugins.eot import DuplicateTextPolicy
        from eidolon.channel.livekit.plugins.eot import TurnDetectionStateManager
        from eidolon.channel.livekit.plugins.eot import TurnEndPolicy
...
class TestL8UserProfileLifecycle:
    ...
    def test_lru_eviction_on_cap_exceeded(self):
        ...
        from eidolon.channel.livekit.plugins.eot.impl.context_enhanced_eot import (
            ContextEnhancedEot,
        )
...
class TestR8DualPathConsistency:
    ...
    async def test_paths_agree_when_no_interrupt_guards_active(self):
        ...
        from eidolon.channel.livekit.plugins.eot import ContextEnhancedEot
