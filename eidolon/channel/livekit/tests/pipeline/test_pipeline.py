...
Run with::
    ...
    cd <repository-root>
    .venv/bin/python -m pytest eidolon/channel/livekit/agent/pipeline/test_pipeline.py -v
"""
...
class TestBatchPipeline:
    ...
    async def test_process_audio_track_calls_stt_llm_tts(self):
        ...
        from eidolon.channel.livekit.agent.pipeline import PipelineCallbacks, PipelineState
        from eidolon.channel.livekit.agent.pipeline.llm import LlmOutput
...
class TestTypes:
    def test_generate_turn_id(self):
        from eidolon.channel.livekit.agent.pipeline import generate_turn_id
