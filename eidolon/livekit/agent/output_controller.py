...
Legacy ``DuckingMixer`` name and ``ducking.py`` module path remain as
shims for one release; new code MUST import ``OutputController`` from
...
logger = logging.getLogger("agent.output_controller")
