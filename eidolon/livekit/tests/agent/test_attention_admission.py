...
def test_pipeline_attention_routes_substantive_playback_speech_without_ducking() -> None:
...
def test_user_transcript_routes_observed_substantive_playback_to_semantic_owner() -> None:
    pipeline = _pipeline_with_client_state(
        _client_state(participant_identity="manson"),
